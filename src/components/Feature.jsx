    ...
    return (
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div class="w-full mb-8 lg:mb-16 items-center">
                    ...
                    <p class="text-gray-500 sm:text-xl dark:text-gray-400">Here at answerwise.ai we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
                </div>
                <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Generative AI Search and Chat</h3>
                        <p class="text-gray-500 dark:text-gray-400">Unleash the power of generative AI with AnswerWise. Our cutting-edge technology ensures precise and contextually accurate responses, revolutionizing the way questions are answered.</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Seamless Integration</h3>
                        <p class="text-gray-500 dark:text-gray-400">Integrate AnswerWise effortlessly into your existing ecosystem. Our user-friendly platform allows for quick setup, ensuring a seamless experience for both you and your users.</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Tailored Chatbot Themes</h3>
                        <p class="text-gray-500 dark:text-gray-400">Customize the look and feel of your chatbot to align with your brand. With a range of themes to choose from, you can create a personalized experience that resonates with your audience.</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Budget-Friendly Subscription Plans</h3>
                        <p class="text-gray-500 dark:text-gray-400">AnswerWise offers flexible subscription plans that cater to businesses of all sizes. Get the benefits of state-of-the-art AI without breaking the bank.</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Project Training and Retraining</h3>
                        <p class="text-gray-500 dark:text-gray-400">Take control of your AI projects with AnswerWise. Train and retrain models to meet your evolving needs. Easily manage, update, and refine your chatbot's capabilities.</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Diverse Training Methods</h3>
                        <p class="text-gray-500 dark:text-gray-400">Choose how you want to train your models. Whether it's through a web URL, document upload, or a text editor, we offer versatile training options to suit your workflow.</p>
                    </div>
                </div>
            </div>
        </section>
